...
- **Modal genérico:** `src/shared/components/dialog/modal.vue` (Teleport + motion-v, slot default + `#footer`) para formulários em diálogo (ex.: convite). Para confirmação destrutiva continue usando o `ConfirmDialog`.
