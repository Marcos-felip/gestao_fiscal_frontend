...
import { SetActiveCompanyUseCase } from '@/modules/account/application/use-cases/set-active-company.use-case'
...
export function makeSetActiveCompanyUseCase(): SetActiveCompanyUseCase {
  return new SetActiveCompanyUseCase(new AccountRepository())
}
