  ...
  <form class="space-y-5" @submit.prevent="handleSubmit">
    ...
    <div>
      ...
      <div class="relative">
        ...
        <button
          type="button"
          class="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground-2 hover:text-foreground transition-colors duration-200"
    ...
    <div class="flex items-center gap-4 my-5">
      <hr class="flex-1 border-line-2" />
      <span class="text-sm font-medium text-muted-foreground-1">Ou</span>
      <hr class="flex-1 border-line-2" />
    </div>

    <!-- Google Button (Ghost/Secondary, Full Width) -->
    <ButtonUi
      type="button"
      variant="ghost"
      class="w-full"
