...
import type { ListPayablesUseCase } from '@/modules/payables/application/use-cases/list-payables.use-case'
import type { CreatePayableUseCase } from '@/modules/payables/application/use-cases/create-payable.use-case'
...
export class PayablesListController extends BaseController {
  private readonly listUseCase: ListPayablesUseCase
  private readonly createUseCase: CreatePayableUseCase
  private readonly toast = useToast()

  readonly payables = ref<Payable[]>([])
  ...
  constructor(
    listUseCase: ListPayablesUseCase,
    createUseCase: CreatePayableUseCase,
  ) {
    super()
  ...
  async loadList(): Promise<void> {
    ...
    this.handleResult(result, (list) => {
      this.payables.value = list.items
  ...
  async create(dto: CreatePayableDto): Promise<boolean> {
